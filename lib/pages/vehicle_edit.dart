...
Future<void> updateVehicle(context) async {
  ...
  try {
    http.Response response = await _client.post(Uri.parse(
        "http://127.0.0.1:13000/updatevehicle?originalvehicleID=$originalvehicleID&vehicleID=$vehicleID&manufacturer=$manufacturer&modelyear=$modelyear&color=$color&sizee=$sizee&trackerid=$trackerid"));
        ...
        showDialog(
            ...
            builder: (context) {
              ...
              return const AlertDialog(
                title: Text("Vehicle Updated successfuly."),
              );
            });
...
class VehicleEdit extends StatefulWidget {
  const VehicleEdit({Key? key}) : super(key: key);

  @override
  _VehicleEditState createState() => _VehicleEditState();
}
